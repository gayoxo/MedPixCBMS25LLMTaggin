...
results_df = pd.read_csv("resultados_embeddings_"+str(threshold)+".csv", delimiter=';', encoding='utf-8')
...
summary.to_csv("metricas_precision_recall_f1_completas_"+str(threshold)+".csv", index=False, sep=';', encoding='utf-8')
